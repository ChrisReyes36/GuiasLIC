var diccionario = [
    ...
    ["Alveo","La madre de un accidente hidrográfico natural, normalmente un arroyo o río."],
    ...
    ["Bonhomia","Afabilidad, sencillez, bondad y honradez en el carácter."],
    ["Burdegano","Híbrido entre un caballo y una asna."],
    ...
    ["Desleir","Disolver algo, de contextura sólida o pastosa, en un líquido."],
    ["Deyeccion","Defecación de los excrementos."],
    ["Eburneo","Hecho de marfil o de un material que se le parece."],
    ...
    ["Gaznapiro","Tonto, palurdo, persona quien se emboba con cualquier cosa."],
    ...
    ["Histrion","Actor teatral. También referido para aquellas personas quienes se expresan con la forma característica de una persona quien está sobreactuando."],
    ...
    ["Joyel","Joya pequeña."],
    ["Labaro","Estandarte que era usado por los antiguos romanos. También es el nombre del monograma formado por la cruz y las dos primeras letras del nombre griego de Cristo."],
    ...
    ["Nubil","Dicho de una persona, especialmente de una mujer, quien se encuentra en edad de casarse."],
    ["Ñengo","Persona enclenque, flaca, desmedrada."],
    ["Ñomblon","Dicho de una persona muy gorda, con buenas nalgas."],
    ...
    ["Regnicola","Habitante natural de un reino. También dicho de quien escribe de las cosas especiales de su patria, como códigos penales, hábitos nacionales, cultura en general."],
    ...
    ["Tremolo","Concepto musical que describe una rápida sucesión de repeticiones de una misma nota."],
    ...
    ["Unigenito","Persona quien es hijo o hija única."],
    ["Vagido","emido o llanto de un recién nacido."],
    ...
    ["Xerofitico","Dicho sobre aquellos vegetales que están adaptados por su estructura a los medios secos."],
...
var out1 = document.getElementById("word");
var out2 = document.getElementById("desc");
var waiting1 = document.getElementById("otherwise");
var waiting2 = document.getElementById("otherwisedesc");
var error = document.getElementById("error");

input.addEventListener("keyup",function(){
    var texto = this.value.trim();
    var regex = RegExp(texto);
    var coin = [];
    if(texto != ""){
        for(var i = 0;i<diccionario.length;i++){
            if(regex.test(diccionario[i][0])){
                coin = diccionario[i];
                break;
            }
        }
        if(coin[0] != null){
            out1.innerHTML = coin[0];
            out2.innerHTML = coin[1];
            error.style.display = "none";
        } else {
            out1.innerHTML = "";
            out2.innerHTML = "";
            out1.appendChild(waiting1);
            out2.appendChild(waiting2);
