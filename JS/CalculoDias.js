...
if (bisiesto == true) {
    document.write("<header><h1>El año " + year + ", es bisiesto." + "</h1><br/> <br /></header > ");
    document.write("<header><h1>El mes " + mes + ", tiene " + diasdelmes + " días." + "</h1><br/> <br /></header > ");
}
else {
    document.write("<header><h1>El año " + year + ", no es bisiesto." + "</h1><br/> <br /></header > ");
    document.write("<header><h1>El mes " + mes + ", tiene " + diasdelmes + " días." + "</h1><br/> <br /></header > ");
}
